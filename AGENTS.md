...
TypeScript + React + Vite + Tailwind. Hosted on GitHub Pages. ~19,000 LOC, 619 tests.
...
npm run test         # Run all Vitest unit tests (619 currently)
...
tests/unit/        Vitest tests (39 test files)
```
