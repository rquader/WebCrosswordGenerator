    ...
    <div className="animate-fade-in max-w-3xl mx-auto space-y-8 pb-12">
      <div className="text-center py-6">
        <div className="w-14 h-14 rounded-2xl bg-accent/10 flex items-center justify-center mx-auto mb-4">
          <svg className="w-7 h-7 text-rubric" fill="none" viewBox="0 0 24 24" strokeWidth={1.5} stroke="currentColor">
      ...
      <section>
        ...
        <div className="ml-10 space-y-4">
          <div className="warm-card p-5">
            <h4 className="text-sm font-semibold text-ink mb-3">Keyboard Controls</h4>
      ...
      <section>
        ...
        <div className="ml-10">
          <div className="bg-well border border-line border-l-2 border-l-rubric rounded-md p-5">
            <div className="flex items-start gap-3">
              <svg className="w-5 h-5 text-rubric flex-shrink-0 mt-0.5" fill="none" viewBox="0 0 24 24" strokeWidth={1.5} stroke="currentColor">
              ...
              <div>
                ...
                <ul className="text-sm text-rubric space-y-1">
...
function SectionTitle({ number, title }: { number: number; title: string }) {
  return (
    <div className="flex items-center gap-3 mb-4">
      <div className="w-8 h-8 rounded-full bg-accent text-accent-ink flex items-center justify-center text-sm font-bold flex-shrink-0">
        {number}
      </div>
...
function StepCard({ icon, title, description }: { icon: React.ReactNode; title: string; description: string }) {
  return (
    <div className="flex gap-3 warm-card p-4">
      <div className="text-rubric flex-shrink-0 mt-0.5">{icon}</div>
      <div>
...
function ExportCard({ icon, title, description }: { icon: React.ReactNode; title: string; description: string }) {
  return (
    <div className="flex gap-3 warm-card p-4">
      <div className="text-ink-3 flex-shrink-0">{icon}</div>
      <div>
        ...
        {keys.map((key, i) => (
          <kbd
            ...
            className="inline-flex items-center justify-center min-w-[28px] h-7 px-1.5
                       bg-well border border-line-2
                       rounded text-xs font-mono font-medium text-ink
                       shadow-sm"
          >
            {key}
          </kbd>
  ...
  return (
    <div className="warm-card overflow-hidden">
      <div className="px-4 pt-4 pb-3">
        <h4 className="text-sm font-semibold text-ink mb-3">Supported File Formats</h4>

        <div className="flex gap-1 bg-well rounded-lg p-1 mb-3">
        ...
        <p className="text-xs text-ink-2 mb-3">{current.description}</p>
      </div>

      <div className="relative bg-well/70 border-t border-line/50">
        <button
          onClick={handleCopy}
          className="absolute top-2 right-2 p-1.5 rounded-md text-ink-3 hover:text-ink
      ...
      <div className="px-4 py-3 bg-well/50 border-t border-line/50">
        <div className="flex items-center gap-2">
          <svg className="w-4 h-4 text-ink-3" fill="none" viewBox="0 0 24 24" strokeWidth={1.5} stroke="currentColor">
